...
function UpdateHotel() {
  ...
  function updateHotelHandler(data: any) {
    const dto = {
      ...
      cover_image:
        typeof data.cover_image === "string" ? null : data.cover_image,
      why_choose_us:
        data.why_choose_us && data.why_choose_us?.blocks[0]?.text?.length
          ? JSON.stringify(data.why_choose_us)
          : null,
      our_facilities:
        data.our_facilities && data.our_facilities?.blocks[0]?.text?.length
          ? JSON.stringify(data.our_facilities)
          : null,
    };
  ...
  useEffect(() => {
    user &&
      reset({
        ...
        cover_image:
          user?.hotel?.cover_full_path ??
          imageFullPath(user?.hotel?.cover_image),
        ...
        why_choose_us: user.hotel.why_choose_us
          ? JSON.parse(user.hotel.why_choose_us)
          : null,
        our_facilities: user.hotel.our_facilities
          ? JSON.parse(user.hotel.our_facilities)
          : null,
          ...
          <div className="white_card card_height_100 mb_30">
            ...
            <div className="white_card_body">
              <h6 className="card-subtitle mb-4">
                Update your bus information here
              </h6>
              <BusForm
