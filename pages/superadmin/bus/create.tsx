import { createBusAdmin } from '@/api/superadmin/bus';
...
function CreateBus() {
  ...
  return (
    <SuperadminLayout title="Bus Management">
      <div className="col-lg-6">
        <div className="white_card card_height_100 mb_30">
          <div className="white_card_header">
            <div className="box_header m-0">
              <div className="main-title">
                <h3 className="m-0">Create Bus Admin</h3>
              </div>
            </div>
          </div>
          <div className="white_card_body">
            <h6 className="card-subtitle mb-4">
              Create new bus admin and share credentials ONLY to trusted people
            </h6>
            <form onSubmit={handleSubmit(createBusHandler)}>
