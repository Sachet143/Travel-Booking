              ...
              <div className="col-lg-8">
                <div className="vendor_form">
                  <div className="tour_booking_form_box">
                    <form action="https://andit.co/projects/html/and-tour/!#" id="tour_bookking_form_item">
                      <div className="row">
                        ...
                        <div className="col-lg-12">
                          <div className="form-group">
                            <input type="text" className="form-control bg_input" placeholder="Street address" />
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="form-group">
                            <input type="text" className="form-control bg_input" placeholder="Apartment, Suite, House no (optional)" />
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="form-group">
                  ...
                  <div className="booking_tour_form_submit pt-4">
                    <div className="form-check write_spical_check">
                      <input className="form-check-input" type="checkbox" defaultValue id="flexCheckDefaultf1" />
                    ...
                    <a href="booking-confirmation.html" className="btn btn_theme btn_md">Sign up</a>
                  </div>
                </div>
              </div>
