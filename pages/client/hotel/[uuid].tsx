...
function HotelPage() {
  ...
  return (
    <ClientLayout>
      <>
        <section id="common_banner" style={{ backgroundImage: `url(${hotel?.cover_full_path ?? '/img/banner/common-banner.png'})` }}>
                        ...
                        <div className="tour_details_top_bottom">
                          {
                            hotel.features.map(f =>
                              <div className="toru_details_top_bottom_item" key={f.id}>
