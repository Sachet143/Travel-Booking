    ...
    <form onSubmit={handleSubmit(submitHandler)}>
      ...
      <div className="row mb-3">
        <div className="col-md-12 col-sm-12 form-group">
          <label className="form-label">Bus Operator Name<span className='text-danger'> *</span></label>
          <input
            {...register("name", { required: "Bus Operator Name is required!" })}
      ...
      <div className="row mb-3">
        <div className="col-md-12 col-sm-12 form-group">
          ...
          <input
            {...register("phone_no", { required: "Bus Operator Phone Number is required!" })}
      ...
      <div className="row mb-3">
        <div className="col-md-12 col-sm-12 form-group">
          ...
          <input
            {...register("address", { required: "Bus Operator Address is required!" })}
